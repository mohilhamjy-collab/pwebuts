...
<!-- JUDUL -->
<h2 class="judul">
    Halaman ini dibuat hasan & ilham
</h2>
...
<div class="container mt-5">
    <div class="row justify-content-center g-5">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
               <img src="{{ asset('img/Hasan.jpg') }}"
    class="card-img-top"
    alt="Foto Profile"
    style="width: 100%; height: 400px; object-fit: cover; object-position: center;">

                <div class="card-body">
                    <h5 class="card-title fw-bold">Hasan</h5>
                    <p class="card-text">Huraaaaaa</p>
                    <p class="text-muted small mb-0">2301010101</p>
                </div>
            </div>
        </div>
    ...
    style="width: 100%; height: 400px; object-fit: cover; object-position: center;">
                ...
                <div class="card-body">
                    <h5 class="card-title fw-bold">Ilham</h5>
                    <p class="card-text">Horaaaa</p>
                    <p class="text-muted small mb-0">2301010100</p>
                </div>
            </div>
        </div>
